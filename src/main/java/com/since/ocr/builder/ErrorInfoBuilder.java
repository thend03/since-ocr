package com.since.ocr.builder;


import com.since.ocr.model.ErrorInfo;
...
public class ErrorInfoBuilder implements HandlerExceptionResolver {
     ...
     */
    @Override
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, @Nullable Object handler, @NotNull Exception ex) {
